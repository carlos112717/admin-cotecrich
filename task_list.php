                        ...
                        <td class="text-center">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item delete_task" onClick="delete_task(<?php echo $row['id'] ?>)"
                                    name="<?php echo $row['id'] ?>" href="javascript:void(0)">Eliminar Tarea</a>
                                <div class="dropdown-divider"></div>
...
$(document).ready(function() {
    ...
    $('.manage_task').click(function() {
        console.log("mauro");
        uni_modal("<i class='fa fa-edit'></i> Editar Tarea", "manage_task.php?id=" + $(this).attr(
            'data-id'), 'mid-large')
    })
    $('.new_progress').click(function() {
        uni_modal("<i class='fa fa-plus'></i> Nuevo progreso de: " + $(this).attr('data-task'),
            "manage_progress.php?tid=" + $(this).attr('data-tid'), 'mid-large')
    })
